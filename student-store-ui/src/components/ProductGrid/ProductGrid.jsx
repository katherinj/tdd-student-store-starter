...
export default function ProductGrid({products, handleAddItemToCart, handleRemoveItemToCart, shoppingCart, category, searchTerm}) {
  ...
  if(searchTerm != ""){
    productList=productList.filter(p => p.name.toLowerCase().includes(searchTerm.toLowerCase()))
